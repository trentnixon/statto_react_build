...
export default class ThreeDimScatterChart extends React.Component {
  ...
  renderTooltip(props) {
    ...
    return (
      <div>
        ...
        <ScatterChart width={500} height={60} margin={{top: 10, right: 0, bottom: 0, left: -30}}>
          <XAxis type="category" dataKey="hour" interval={0} tick={{ fontSize: 0 }} tickLine={{ transform: 'translate(0, -6)' }} />
          <YAxis type="number" dataKey="index" name="sunday" height={10} width={80} tick={false} tickLine={false} axisLine={false} label="< Ten"/>
